# Implement a decorator function called `order_decorator` that will be
# used to `print` the values 1, 2, 3, 4 in order while the callback is
# in the middle of two print statements. The decorator function should
...
# - Initializes a variable of that calls the `middle` callback
#   function with the argument passed into the wrapper

# - A `print` statement of the integer 3
# - Returns the variable of the callback function

# Finally, be sure to decorate `middle` function using the decorator
# syntax.
